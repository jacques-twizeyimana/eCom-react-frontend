    ...
    <div>
      ...
      <div className="bg-gray-100 h-96">
        <div className="flex h-5/6 ">
          <div className=" w-2/6 ">
            <div className="m-16">
              ...
              <p className="mt-8 p-2" style={{ fontSize: "15px" }}>
        ...
        <div className="h-1/6 border-t-2 ">
          <p
            className=" font-medium text-center p-4"
            style={{ fontSize: "13px" }}
          >
            Copyright@2021Alright reserved | This template is made with
            ...
            by TheBosses from <span className="text-red-600">OpenRCA</span>
          </p>
        </div>
      </div>
    </div>
