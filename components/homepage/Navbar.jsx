        ...
        <div className="w-full border-b border-gray-200 px-5 py-4">
            <nav className="flex-row md:justify-between">
                <div className="flex flex-row justify-between">
                    <div>
                        <img className="hidden pr-2" src="/favicon.ico" width="30" height="30" />
                        <span className="text-3xl text-black font-bold italic px-3 inline-block font-edo">E-SHOP</span>
                    ...
                    <div id="hamburgerbtn" className="md:hidden">
                        <button className={"focus:outline-none"} onClick={()=> setActive(!active)}><svg className="inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M3 4h18v2H3V4zm6 7h12v2H9v-2zm-6 7h18v2H3v-2z"/></svg></button>
                    </div>
                </div>
            </nav>


                    <ul className={(active ? "block " : "hidden ") + "transition-display md:hidden pt-3 border-t border-gray-300"} id="mobileMenu">

                        <li className="pr-5 my-2 md:my-auto search border py-2 px-3 border-gray-300 rounded-md ">
                            <svg  className="inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18"><path fill="none" d="M0 0h24v24H0z"/><path d="M11 2c4.968 0 9 4.032 9 9s-4.032 9-9 9-9-4.032-9-9 4.032-9 9-9zm0 16c3.867 0 7-3.133 7-7 0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7zm8.485.071l2.829 2.828-1.415 1.415-2.828-2.829 1.414-1.414z" fill="rgba(52,72,94,1)"/></svg>
                            <input  className=" mx-2 text-sm placeholder-black text-black bg-transparent focus:outline-none" placeholder="Search here..." type="text" name="search" id="searchInput"/>
                        </li>
                        <li className="my-2 md:my-auto"><a> Home</a></li>
                        <li className="my-2 md:my-auto"><a> Shop</a></li>
                        <li className="my-2 md:my-auto"><a> Latest
                        <sup>
                            <span className="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-red-600 rounded-sm ml-1">HOT</span></sup>
                        </a>
                        </li>
