                    ...
                    <div className="flex flex-row justify-between">
                        <Link href={"/"}>
                            <div>
                                ...
                                />
                                <a href={"#"}
                                    className="text-3xl text-black font-bold italic px-3 inline-block font-edo">E-SHOP</a>
                            </div>
                        </Link>
                        ...
                        <ul className={"hidden md:flex md:flex-row"} id="mobileMenu">
                                ...
                                <li className="pr-5 my-2 sm:hidden lg:inline-block md:my-auto">
                                    <Link href={"/products#latest"}><a>Latest
                                        <sup className={"sm:hidden lg:inline-block "}><span className="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-red-600 rounded-sm ml-1">HOT</span></sup>
                                    </a></Link>
                                </li>
