...
export default function Navbar() {
  ...
  const changeAuthModalShown = (newState = !isAuthModalShown) => {
    setisAuthModalShown(newState);
  };

  return (
    <div>
      <AuthenticationModel
        isModalShown={isAuthModalShown}
        changeModalShown={changeAuthModalShown}
      ></AuthenticationModel>
      <div className="w-full border-b border-gray-200 px-5 py-4">
        <nav className="flex-row md:justify-between">
          <div className="flex flex-row justify-between">
            <div>
              ...
              />
              <Link href="/">
                <a className="text-3xl text-black font-bold italic px-3 inline-block font-edo">
                  E-SHOP
                </a>
              </Link>
            </div>
            ...
            <div className="hidden md:inline-block shopping-data">
              ...
              <Link href="/cart">
                <a className="ml-5 focus:outline-none">
                  <svg
                    className="inline"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
        ...
        <Modal
          className="bg-black flex justify-center h-screen bg-opacity-70 p-12"
          style={{ zIndex: 999 }}
          isOpen={ModelIsOpen}
        >
          <div className="bg-white w-1/2 relative p-2">
            <div
              ...
              className=" absolute right-2 text-white text-center text-white rounded rounded-full w-6 h-6 bg-black"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <div className="flex justify-center p-2">
              ...
              >
                <path fill="none" d="M0 0H24V24H0z" />
                <path
                  d="M12.001 4.529c2.349-2.109 5.979-2.039 8.242.228 2.262 2.268 2.34 5.88.236 8.236l-8.48 8.492-8.478-8.492c-2.104-2.356-2.025-5.974.236-8.236
               2.265-2.264 5.888-2.34 8.244-.228z"
                  fill="rgba(244,48,48,1)"
                />
              </svg>
            </div>
            <div className="grid grid-cols-3">
              <div className="w-4/5">
                ...
                <p className=" text-center p-1.5 text-gray-400 text-sm">
                  Mens Sneakers
                </p>
                ...
                <div className="flex justify-center">
                  ...
                  >
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path
                      d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0-9.414l2.828-2.829 1.415 1.415L13.414 12l2.829
                2.828-1.415 1.415L12 13.414l-2.828 2.829-1.415-1.415L10.586 12 7.757
                 9.172l1.415-1.415L12 10.586z"
                    />
                  </svg>
                </div>
              </div>
